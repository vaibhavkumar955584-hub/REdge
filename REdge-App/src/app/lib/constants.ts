...
export const LETTER_WIDTH_PX = Math.ceil(LETTER_WIDTH_PT * PX_PER_PT);
export const LETTER_HEIGHT_PX = Math.ceil(LETTER_HEIGHT_PT * PX_PER_PT);

// Reference: https://www.prepressure.com/library/paper-size/din-a4
export const A4_WIDTH_PT = 595;
export const A4_HEIGHT_PT = 842;
export const A4_WIDTH_PX = Math.ceil(A4_WIDTH_PT * PX_PER_PT);
export const A4_HEIGHT_PX = Math.ceil(A4_HEIGHT_PT * PX_PER_PT);
