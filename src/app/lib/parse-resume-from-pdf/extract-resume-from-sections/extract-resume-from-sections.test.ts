...
describe("extract-profile tests - ", () => {
  ...
  it("Email", () => {
    expect(matchEmail(makeTextItem("  vaibhavkumar955584@gmail.com  "))![0]).toBe(
  ...
  it("Url", () => {
    expect(matchUrl(makeTextItem("  linkedin.com/in/redge  "))![0]).toBe(
      "linkedin.com/in/redge"
    );
    expect(matchUrl(makeTextItem("vaibhavkumar955584@gmail.com"))).toBeFalsy();
  });
});
